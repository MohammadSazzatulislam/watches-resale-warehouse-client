    ...
    <div className="flex justify-center">
      <div className="block rounded-lg w-full shadow-lg bg-white ">
        ...
        <div className="p-5">
          ...
          {product.stutas === "stock out" ? (
            <>
              <label
                disabled
                type="button"
                className=" inline-block px-6 py-2.5 w-full text-center bg-blue-300 text-white font-medium text-xs leading-tight uppercase rounded shadow-md  transition duration-150 ease-in-out"
              >
                booked
              </label>
            </>
